...
::
      ...
      monitor_yaml_config: |
          ...
          nuageMonServer:
              URL: 0.0.0.0:9443
              certificateDirectory: /etc/kubernetes/pki               <--- Set this to the cert-dir which holds the client certificates 
	      clientCA: "/etc/kubernetes/pki/ca.crt"                       generated by kubernetes during kubeadm init phase and also
              serverCertificate: "/etc/kubernetes/pki/apiserver-kubelet-client.crt" <--- make sure that the client and server cert and 
              serverKey: "/etc/kubernetes/pki/apiserver-kubelet-client.key"              key do exist in the cert-dir
