...
// 	conf.MasterConfig.NetworkConfig.ClusterNetworks = append(conf.MasterConfig.NetworkConfig.ClusterNetworks, struct {
// 		CIDR         string `yaml:"cidr"`
// 		SubnetLength int    `yaml:"hostSubnetLength"`
// 	}{CIDR: "70.70.0.0/16", SubnetLength: 8})
...
// 	getResp, err := nuageetcd.client.Get(context.Background(), SubnetMetadataTree+"ns/ns-0")
// 	if err != nil {
// 		t.Fatalf("Getting key from etcd failed with error: %v", err)
// 	}

// 	if len(getResp.Kvs) != 1 {
// 		t.Fatalf("received unexpected number(%d) of kv pairs for key %s", len(getResp.Kvs), SubnetMetadataTree+"ns/ns-0")
// 	}
// 	s := &etcdSubnetValue{}
...
// 	getResp, err = nuageetcd.client.Get(context.Background(), SubnetMetadataTree+"ns/"+subnet)
// 	if err != nil {
// 		t.Fatalf("Getting key from etcd failed with error: %v", err)
// 	}
...
// 		getResp, err = nuageetcd.client.Get(context.Background(), SubnetMetadataTree+"ns/ns", clientv3.WithPrefix())
// 		if err != nil {
// 			t.Fatalf("Getting key from etcd failed with error: %v", err)
// 		}
...
// 	if getResp, err := nuageetcd.client.Get(context.Background(), ZoneMetadataTree+zoneInfo.Name); err != nil {
